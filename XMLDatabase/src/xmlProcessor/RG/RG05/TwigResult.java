...
public class TwigResult 
{
	...
	private boolean isDummyRes = false;
...
//		this.comps = new TwinArrayList<QTPNode, ArrayList<TwinObject<QTPNode,Integer>>>();
	...
	public TwigResult clone()
	{
		...
		result.isDummyRes = this.isDummyRes;
...
//	}
	...
	/**
	 * join the twigResult to this object, set Dummy to false;
	 * @param twigResult
...
//	}
	...
	public QueryTuple getRes(ArrayList<QTPNode> QTPNodes)
	{
		QueryTuple tuple = new QueryTuple();                
                /////////ooldooz:Just to change the order od nodes at 303:               
//                ArrayList<QTPNode> QTPNodes1=new ArrayList<>();
//                QTPNodes1.add(QTPNodes.get(0));
//                QTPNodes1.add(QTPNodes.get(2));
//                QTPNodes1.add(QTPNodes.get(1));
//                QTPNodes1.add(QTPNodes.get(3));
                //////////////////
...
//	}
	...
	{
		this.isDummyRes = true;
	}
	
	public boolean isDummy()
	{
		return this.isDummyRes;
	}
