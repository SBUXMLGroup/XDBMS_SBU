...
public class EvaluationTree implements QueryStatistics
{
	private EvaluationTreeNodeInput root;
        private EvaluationTreeNode root1;
...
//                //////
	...
	public void open() throws DBException, IOException, InterruptedException
	{
		...
		{
                        logManager.LogManager.log(9,"g to point1");
			this.head = this.root.getHead();
                        logManager.LogManager.log(9,"point1");
		}
	...
	{
                /////CHANGE:
		this.root.next(); //DEQueueing Root
//                if (this.root.isFinished())
//		{
//			this.head = null;
//			this.isFinished = true;
//		}
//               	else
                    logManager.LogManager.log(9,"g to point2");
                    this.head = this.root.getHead();
                    logManager.LogManager.log(9,"point2");
                //this.head=this.root.internalNext();
                /////////////////
		if (this.head == null)
		{
			this.isFinished = true;
