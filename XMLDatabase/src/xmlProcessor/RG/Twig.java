...
import xmlProcessor.RG.QueryResult;
...
//		}
        ...
        public void customizedPrepare(int planNo,String indexName,String TwigMethod )
        {
            this.indexName=indexName;
            this.planNo=planNo;
            this.TwigMethod=TwigMethod;
        }
...
//                //my plan3:
//                out.append("//z[/p]/r\n");
//		QTPNode root = new QTPNode("z", null, QTPSettings.AXIS_DESCENDANT);
//                QTPNode p = new QTPNode("p", root, QTPSettings.AXIS_CHILD);
//                QTPNode r = new QTPNode("r", root, QTPSettings.AXIS_CHILD);
//                
//                //my plan2:
//                out.append("//A[//D]/G//N\n");
//		QTPNode root = new QTPNode("A", null, QTPSettings.AXIS_DESCENDANT);
...
//			operator = new QueryRG00Op(context, QTP, idxNo, true);
		...
		{
			operator = new QueryRG01Op(QTP,indexName);
		}
...
//			operator = new XTCxqueryRG04Op(context, QTP, idxNo);
		...
		{
			operator = new QueryRG05Op( QTP,indexName);
		}
		else if (TwigMethod.equals("RG06"))
		{
			operator = new QueryRG06Op(QTP,indexName);
		}
                else if (TwigMethod.equals("RG07"))
		{
			operator = new QueryRG07Op(QTP,indexName);
		}
		else
		{
...
//		try 
//		{
//			outFile = new FileWriter("D:\\Res-" + TwigMethod + ".txt");
//			outF = new PrintWriter(outFile);
//                        inFile=new FileReader("D:\\Res-RG05.txt");                        
////                        comp=new Comparator();
////                        comp.open(inFile);
//		}
//		catch (IOException e)
		...
		QueryTuple last = null; 
			...
			if (matchCount < 10)
			{
				out.append(tuple.toString() + "\n\n");
                        ...
                        this.matchCount++;
                        //logManager.LogManager.log(7,"MatchCount: "+matchCount);
//                        System.out.println("MatchCount: "+matchCount);
//////////////////////////////////////
//////////////////////////////////////
//////////////////////////////////////
                       // comp.compare(tuple.toString(),matchCount);
...
//		this.readPages = ep-sp;
                this.readPages=monitor.getReadPages();
                this.readPagesAttempts=monitor.getReadPagesAttempt();
                if (!TwigMethod.equals("TJFASTNOPIPE"))
		{
			//this.numberOfReadElements = ((QueryStatistics)operator).getNumberOfReadElements();
			this.IOTime = monitor.getIOTime();
                        this.numberOfReadElements=monitor.getElementsRead();
		}
