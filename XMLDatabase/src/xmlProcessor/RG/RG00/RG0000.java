...
//	 * 
//	 * */
//	public RG0000(QueryTreePattern QTP,String indexName,boolean docOrdered) throws DBException
//	{
//		
...
//	 * */
//	public RG0000(QueryTreePattern QTP,String indexName) throws DBException
//	{
...
//                        //ooo
//			if (RG0000.this.IO_Mode == IO_ModeType.DIRECT)
//			{
...
//			
//			return new TwigResult(RG0000.this.QTP, qNode, tuple);
//			
////			ArrayList<DeweyID> addition = new ArrayList<DeweyID>();
////			//long s = System.currentTimeMillis();
////			for (int i = 0; i < resArr.size(); i++) 
...
//                                logManager.LogManager.log(6,"ps.getCID(): "+psNode.getCID());
