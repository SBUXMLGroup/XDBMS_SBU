...
public class DeweyID 
{    
    private ArrayList<Integer> deweyID;
    private int CID;
    public DeweyID()
    {
       deweyID = new ArrayList<Integer>();
       CID=0;
       //CID=0 is used for attributes and contents
    }
    public DeweyID(ArrayList<Integer> deweyID)
    {
    ...
    public int getFirsttDiv()
    {
        return deweyID.get(deweyID.size()-1);
    }
    public int getAttrDiv()
    {
...
//    }
    ...
    public void addDivision(int curPart)
    {
...
//        }
    ...
    {
        DeweyID anc;
        ArrayList<Integer> ancDivs=new ArrayList<>();
       // for(int i=deweyID.size()-1;i>=;i--)//i=0 up to <level i=x down to >x-level
        ...
        for(int i=0;i<=level;i++)//because level starts from zero
        {
            ...
            {
                System.out.println(deweyID.toString());
                throw e;
            }
    ...
    public int compareTo(DeweyID anotherDeweyID)
    {
        //func: to compare twe IDs up to some level
         logManager.LogManager.log(9,"point10");
        int sizeOfThis=this.deweyID.size();        
        int sizeOfAnother=anotherDeweyID.deweyID.size();
        logManager.LogManager.log(9,anotherDeweyID.deweyID.toString());
...
//        else 
    ...
    public boolean isAncestorOrSelfOf(DeweyID o1) {
        return this.isSelfOf(o1)|| this.isAncestorOf(o1);
        //is that right?
    }

    public Integer getLogicalLevel() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public boolean isAncestorOf(DeweyID cdeweyID) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
