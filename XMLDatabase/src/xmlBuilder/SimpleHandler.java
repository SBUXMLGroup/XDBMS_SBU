...
//bayd curID(string) ba curDeweyID(class) replce shavad
public class SimpleHandler extends DefaultHandler
{
     ...
     public SimpleHandler(Document doc)
     {
        this.doc=doc;
        elements=new Stack();
...
//        curDeweyID.toString();
    ...
    public void startElement(String uri, String localName,
    	            ...
    	            throws SAXException 
    {
         	          LogManager.log(0,String.valueOf("Element: "+ ++elemCounter+" ,"+qName));
                  elements.push(uri);
                  ...
                  if(lastMovement)
                  {
                     ...
                     //First child:
                    curPart=1;
                    curDeweyID.addDivision((short)curPart);                    
...
//         }
    	                ...
    	                throws SAXException
    {
          ...
          if(!lastMovement)
          {    childNumerator.pop();//(>,>): last curPart bayad remove shavad
               LogManager.log(0,"Childred of "+qName+" are: "+Children);
          }
